...
class Livre {
  ...
  Future<String> getABook() async {
    ...
    if (response.statusCode == 200) {
      ...
      print(jsonResponse[
          'publishers']); // this.editor = jsonResponse['publishers']; //return a tab //this.editor.forEach((element) => print(element));
      jsonResponse['publishers'].forEach(
          (element) => this.editor.insert(this.editor.length, element));
      ...
      this.urlCover_Taille_S =
          "http://covers.openlibrary.org/b/isbn/9782809491708-S.jpg";
      this.urlCover_Taille_M =
